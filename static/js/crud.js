document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('tipoConfiguracionField:', tipoConfiguracionField);
    console.log('tipoServicioField:', tipoServicioField);
    console.log('tipoEquipoField:', tipoEquipoField);
    ...
    var fieldsToShowVPNALTJUN = ['id_cfs', 'id_dko', 'id_vt', 'id_tipo_configuracion', 'id_tipo_servicio', 'id_tipo_equipo', 'id_rfs_ip_port', 'id_cliente', 'id_sede', 'id_sw', 'id_interface_sw','id_vrf','id_rd', 'id_unit', 'id_sv', 'id_cv', 'id_bw','id_wan','id_asn','id_lbcpe','id_lnnid', 'id_bundle_ether', 'id_pe', 'id_interface_pe'];
    var fieldsToShowADIALTALC = ['id_cfs', 'id_dko', 'id_IES', 'id_tipo_configuracion', 'id_tipo_servicio', 'id_tipo_equipo', 'id_rfs_ip_port', 'id_cliente', 'id_sede', 'id_sw', 'id_interface_sw', 'id_vt', 'id_sv', 'id_cv', 'id_bw','id_wan','id_wanv6','id_asn','id_lan','id_lbcpe','id_lnnid', 'id_bundle_ether', 'id_pe', 'id_interface_pe','id_puertos_lag','id_lag'];
    ...
    var fieldsToShowVPLSALTJUN = ['id_cfs', 'id_dko', 'id_tipo_configuracion', 'id_tipo_servicio', 'id_tipo_equipo', 'id_rfs_ip_port', 'id_rfs_ip_port_b', 'id_cliente', 'id_sede', 'id_sede_b', 'id_sw', 'id_interface_sw', 'id_sw_b', 'id_interface_sw_b', 'id_unit', 'id_cv', 'id_sv', 'id_unit_b', 'id_bundle_ether', 'id_pe', 'id_interface_pe','id_bw', 'id_bundle_ether_b', 'id_pe_b', 'id_interface_pe_b'];
    ...
    function updateFieldVisibility() {
        ...
        console.log('tipoConfiguracion:', tipoConfiguracion);
    ...
    console.log('tipoConfiguracionField changed');
