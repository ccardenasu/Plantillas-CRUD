document.addEventListener('DOMContentLoaded', function() {
    ...
    var fieldsToShowADIALTALC = ['id_cfs', 'id_dko', 'id_IES', 'id_tipo_configuracion', 'id_tipo_servicio', 'id_tipo_equipo', 'id_rfs_ip_port', 'id_cliente', 'id_sede', 'id_sw', 'id_interface_sw', 'id_sv', 'id_cv', 'id_bw','id_wan','id_wanv6','id_asn','id_lan','id_lbcpe','id_lnnid', 'id_bundle_ether', 'id_pe', 'id_interface_pe','id_puertos_lag','id_slag'];
    ...
    var fieldsToShowADIALTJUN = ['id_cfs', 'id_dko', 'id_tipo_configuracion', 'id_tipo_servicio', 'id_tipo_equipo', 'id_rfs_ip_port', 'id_cliente', 'id_sede', 'id_sw', 'id_interface_sw', 'id_unit', 'id_bw','id_wan','id_wanv6','id_lan', 'id_bundle_ether', 'id_pe', 'id_interface_pe'];
    ...
    function updateFieldVisibility() {
        ...
        allFields.forEach(field => {
            if (tipoConfiguracion === 'Ampliacion' && tipoServicio === "VPN" && tipoEquipo === "JUNIPER") {
                ...
                console.log('Activando campos para Alta ADI ALCATEL');
