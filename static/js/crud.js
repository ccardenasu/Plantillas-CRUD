    document.addEventListener('DOMContentLoaded', function() {
        ...
        var fieldsToShowVPNALTJUN =     [ 'id_asn','id_be','id_bw','id_bundle_ether','id_cfs','id_cliente','id_cv','id_dko','id_interface_pe','id_interface_sw','id_lbcpe','id_lnnid','id_pe','id_rd','id_rfs_ip_port','id_sede','id_sv','id_sw','id_tipo_configuracion','id_tipo_equipo','id_tipo_servicio','id_unit','id_vrf','id_vt','id_wan'];      
