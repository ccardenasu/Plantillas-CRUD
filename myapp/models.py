...
class Datos(models.Model):
    ...
    bw_voz = models.CharField(max_length=100, default="0")
    bw_video = models.CharField(max_length=100, default="0")
    ...
    rd2 = models.CharField(max_length=100, blank=True, null=True)
    ...
    vrf2 = models.CharField(max_length=100, blank=True, null=True)
