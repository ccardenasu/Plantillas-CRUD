...
class DatosForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "bw_voz": forms.TextInput(attrs={"class": "form-control"}),
            "bw_video": forms.TextInput(attrs={"class": "form-control"}),
            ...
            "rd2": forms.TextInput(attrs={"class": "form-control"}),
            ...
            "vrf2": forms.TextInput(attrs={"class": "form-control"}),
